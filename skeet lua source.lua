...
picurl = "https://cdn.discordapp.com/attachments/1282384582993252455/1322296008025313280/yiSVCqv.jpg?ex=67705b9f&is=676f0a1f&hm=93630b0eeba3a910adb43979acdd8a07cd6aabbab54b328ff10847a8b16593e0&"
...
local ref = { -- Main refs.
   ...
   freestand_key = ui.reference("AA", "Anti-aimbot angles", "\nFreestanding key"),
   ...
   fforcebaim = ui.reference("RAGE", "Aimbot", "Force body aim"),
   pforcebaim = ui.reference("RAGE", "Aimbot", "Prefer body aim"),
...
local function main()
        ...
        antiaimexploits = ui.new_multiselect(aatab[1], aatab[2], "animations", "jumping", "landing", "air walk")
    ...
    local function prerenderstuff()
        if ui.get(antiaimenable) then
            ...
            if ui.get(antiaimlegmovement) == "always" then
                ...
                --end
                --land
                if contains(ui.get(antiaimexploits), "air walk") then
